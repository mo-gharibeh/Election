...
//
  ...
  if ($("#countdown_block").length > 0) {
    var $countdown_block = $("#countdown_block"),
      countdown_date = "2025/02/26"

    // Countdown Date
    if ($countdown_block.attr("data-countdown_date")) {
      countdown_date = $countdown_block.data("countdown_date")
    }

    $("#countdown_block").countdown(countdown_date, function (event) {
